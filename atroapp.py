...
# =================== HAZARD CHECK ==================
if not df.empty:
    # Check for asteroids within hazard threshold
    ...
    if not hazard_asteroids.empty:
        ...
        # Add download button for hazard data
...
with tab_viz:
    if not df.empty:
        ...
        # Scatter plot: Diameter vs Distance colored by Velocity
        ...
        fig1 = px.scatter(
            ...
            title="Asteroid Size vs Distance (colored by velocity)"
        )
...
with tab_3d:
    ...
    if not df.empty:
        ...
        try:
            ...
            st.warning("⚠️ SciPy not available. Some advanced 3D features will be simplified.")
